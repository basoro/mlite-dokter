...
import { Users, Search, Filter, X, Clock, Calendar as CalendarIcon, ArrowRight, List, Activity } from 'lucide-react';
...
const tabs = [
  { key: 'hemodialisa', label: 'Hemodialisa', icon: Activity },
];

const Hemodialisa = () => {
  const [activeTab, setActiveTab] = useState('hemodialisa');
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-xl font-bold text-foreground">Pasien Hemodialisa</h1>
        </div>
        <p className="text-sm text-muted-foreground">
          Pasien yang mendapatkan pelayanan cuci darah (hemodialisa)
        </p>
      </div>
      ...
      <div className="bg-card rounded-xl border p-6 shadow-sm space-y-4">
        {!activePatientTab ? (
          <>
            <h2 className="text-base font-bold text-foreground">Daftar Pasien Hemodialisa Hari Ini</h2>
            ...
            <DataTable 
              ...
              data={data?.data || []} 
              isLoading={isLoading} 
              emptyMessage="Tidak ada data Hemodialisa"
